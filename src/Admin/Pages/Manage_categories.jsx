                        ...
                        <tbody>
                          {
                            data.map((value, index, arr) => {
                              return (
                                <tr key={index}>
                                  <td>{value.id}</td>
                                  <td><img src={value.img} width="75px" alt="" /></td>
                                  <td>{value.name}</td>
                                  ...
                                  <td>
                                    ...
                                    <button className="btn btn-danger btn-xs" onClick={() => deleteid(value.id)}><i className="fa fa-trash-o " onClick={() => deleteid(value.id)} /></button>
                                  </td>
                                </tr>
                              )
                            })
